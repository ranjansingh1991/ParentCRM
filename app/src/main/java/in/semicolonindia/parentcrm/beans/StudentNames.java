...
public class StudentNames {
    ...
    public StudentNames(String name, String eMail, String sClassID) {
        this.name = name;
        this.eMail = eMail;
        this.sClassID = sClassID;
    }

    public StudentNames(String name, String eMail, String sStudID, boolean noUse) {
        this.name = name;
        this.eMail = eMail;
        this.sStudID = sStudID;
    }

    public StudentNames(String name, String eMail, String sClassID, String sSectionID) {
        this.name = name;
        this.eMail = eMail;
        this.sClassID = sClassID;
        this.sSectionID = sSectionID;
    }
    public StudentNames(String name, String eMail, String sClassID, String sStudID, int i) {
        this.name = name;
        this.eMail = eMail;
        this.sClassID = sClassID;
        this.sStudID = sStudID;
    ...
    public StudentNames(String name, String eMail, String sClassID, String sStudID, String sectionID) {
        this.name = name;
        this.eMail = eMail;
        this.sClassID = sClassID;
        this.sStudID = sStudID;
