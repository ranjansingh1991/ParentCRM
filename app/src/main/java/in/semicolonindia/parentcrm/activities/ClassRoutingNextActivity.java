...
import in.semicolonindia.parentcrm.adapters.DayNamesListAdapter;
import in.semicolonindia.parentcrm.adapters.RoutinSubjectsHorzListAdapter;
import in.semicolonindia.parentcrm.beans.ClassRoutine;
import in.semicolonindia.parentcrm.dialogs.ProgressDialog;
import in.semicolonindia.parentcrm.util.PreferencesManager;

import static in.semicolonindia.parentcrm.rest.BaseUrl.sGetRoutineURL;
import static in.semicolonindia.parentcrm.rest.BaseUrl.sGetSubjectURL;

@SuppressWarnings("ALL")
public class ClassRoutingNextActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_class_routing_next);
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ClassRoutingNextActivity.this, ClassRoutinActivity.class);
        ...
        mProgressDialog = new ProgressDialog(ClassRoutingNextActivity.this, "Loading Class Routing...");
