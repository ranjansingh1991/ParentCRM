...
import in.semicolonindia.parentcrm.adapters.ExamMarksAdapter;
...
import static in.semicolonindia.parentcrm.rest.BaseUrl.sGetExamList;
...
public class ExamMarksActivity extends AppCompatActivity {
    ...
    ExamMarksAdapter mExamMarksAdapter;
        ...
        lvStudentName.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (new ConnectionDetector(getApplicationContext()).isConnectingToInternet()) {
                    ...
                    final NoConnectionDialog mNoConnectionDialog = new NoConnectionDialog(ExamMarksActivity.this,
            ...
            public void onResponse(String response) {
                if (response != null) {
                    ...
                    try {
                        ...
                        mExamMarksAdapter = new ExamMarksAdapter(getApplicationContext(), arraylist, lvStudentName);
    ...
    private void getExamID(final String class_id, final String section_id, final String stud_id) {
        ...
        mProgressDialog.setCanceledOnTouchOutside(false);
        mProgressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, sGetExamList, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                if (response != null) {
                    Log.d("response", response);
                    try {
                        ...
                        Intent intent = new Intent(getApplicationContext(), ExamMarksNextActivity.class);
