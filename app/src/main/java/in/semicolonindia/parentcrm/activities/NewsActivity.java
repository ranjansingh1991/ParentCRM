...
import in.semicolonindia.parentcrm.adapters.NewsAdapter;
import in.semicolonindia.parentcrm.beans.NewsName;
...
public class NewsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sDes = new String[]{
                "your life. I am sure you are excited. There are few days in human life when one is truly elated.",
        ...
        lv_News= (ListView) findViewById(R.id.lvNews);

        for (int i = 0; i < sDate.length; i++){
            NewsName newsName = new NewsName(sTitle[i], sImages[i], sDate[i], sTime[i], sAdvertisement[i], sDes[i]);
