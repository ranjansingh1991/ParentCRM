...
import in.semicolonindia.parentcrm.adapters.MessageListAdapter;
...
public class MessageNextActivity extends AppCompatActivity /*implements View.OnClickListener*/ {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_message_next);
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MessageNextActivity.this, MessageActivity.class);
    ...
    private void getMessages() {
        final ProgressDialog mProgressDialog = new ProgressDialog(MessageNextActivity.this, "Loading Messages...");
