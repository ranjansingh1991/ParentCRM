...
import in.semicolonindia.parentcrm.adapters.AccountListAdapter;
import in.semicolonindia.parentcrm.beans.AccountBean;
import in.semicolonindia.parentcrm.dialogs.ProgressDialog;
import in.semicolonindia.parentcrm.util.CropingOption;
import in.semicolonindia.parentcrm.util.CropingOptionAdapter;
import in.semicolonindia.parentcrm.util.PreferencesManager;

import static in.semicolonindia.parentcrm.rest.BaseUrl.sGetAUploadImageURL;
import static in.semicolonindia.parentcrm.rest.BaseUrl.sGetProfile;
...
public class AccountActivity extends AppCompatActivity {
    ...
    private void getData() {
        mProgressDialog = new ProgressDialog(AccountActivity.this, "Uploading...", "Loading profile data...");
    ...
    private void uploadImageToServer(final String sTempImg) {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, sGetAUploadImageURL, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                parameters.put("login_type", "parent");
