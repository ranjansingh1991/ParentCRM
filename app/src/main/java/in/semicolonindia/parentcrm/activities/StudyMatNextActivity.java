...
import in.semicolonindia.parentcrm.adapters.StudyMatListAdapter;
import in.semicolonindia.parentcrm.beans.StudyMatNames;
import in.semicolonindia.parentcrm.dialogs.ProgressDialog;

import static in.semicolonindia.parentcrm.rest.BaseUrl.sGetStudyMaterialURL;

@SuppressWarnings("ALL")
public class StudyMatNextActivity extends AppCompatActivity {
    ListView lvStudyMat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_study_mat_next);
       ...
       // tvToolbarTitle.setText(getString(R.string.study_material_));
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(StudyMatNextActivity.this, StudyMatActivity.class);
    ...
    private void getStudyMaterial() {
        mProgressDialog = new ProgressDialog(StudyMatNextActivity.this, "Loading Study Loading...");
                    ...
                    try {
                        ...
                        if (!jsonObject.getBoolean("error")) {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                StudyMatNames itemDetails = new StudyMatNames(studyMatObject.getString("title"),
                            ...
                            mStudyMatListAdapter = new StudyMatListAdapter(StudyMatNextActivity.this, arraylist, lvStudyMat);
                            lvStudyMat.setAdapter(mStudyMatListAdapter);

                        } else {
                            Toast.makeText(StudyMatNextActivity.this, "Oops! Something went wrong. Please try again.", Toast.LENGTH_LONG).show();
                        }
                    } catch (JSONException e) {
                        e.printStackTrace();
                        mProgressDialog.dismiss();
                    }
                    mStudyMatListAdapter.notifyDataSetChanged();
    ...
    public void onBackPressed() {
        ...
        Intent intent=new Intent(getApplicationContext(),StudyMatActivity.class);
        startActivity(intent);
        finish();
    }
