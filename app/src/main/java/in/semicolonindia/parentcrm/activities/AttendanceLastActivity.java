...
import in.semicolonindia.parentcrm.adapters.AttendanceAdapter;
import in.semicolonindia.parentcrm.beans.AttendanceData;
...
import static in.semicolonindia.parentcrm.rest.BaseUrl.sGetAttendanceListURL;

@SuppressWarnings("ALL")
public class AttendanceLastActivity extends AppCompatActivity {
       ...
       SimpleDateFormat sdfYear = new SimpleDateFormat("yyyy");
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AttendanceLastActivity.this, AttendanceFirstActivity.class);
    ...
    private void getAttendanceList(final int month) {
        mProgressDialog = new ProgressDialog(AttendanceLastActivity.this, "Loading Attendance...");
                ...
                if (sResult != null) {
                    try {
                        ...
                        if (!jsonObject.getBoolean("error")) {
                            ...
                            Toast.makeText(AttendanceLastActivity.this, "Oops! Something went wrong. Please try again.", Toast.LENGTH_LONG).show();
                        }
