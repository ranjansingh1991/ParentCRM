...
import in.semicolonindia.parentcrm.adapters.StudentTransportAdapter;
...
public class TransportActivity extends AppCompatActivity implements BaseUrl {

    ListView lvStudentName;
    StudentTransportAdapter mStudentListAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvStudentName.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(getApplicationContext(), TransportNextActivity.class);
                intent.putExtras(bundle);
                startActivity(intent);
                overridePendingTransition(R.anim.slide_in_bottom, R.anim.slide_out_bottom);
                } else {
                    final NoConnectionDialog mNoConnectionDialog = new NoConnectionDialog(TransportActivity.this,
    ...
    {
        mProgressDialog = new ProgressDialog(TransportActivity.this, "Loading Transport...");
            ...
            public void onResponse(String response)
            {
                if (response != null) {
                    ...
                    try
                    {
                        ...
                        mStudentListAdapter = new StudentTransportAdapter(getApplicationContext(), arraylist, lvStudentName);
                ...
                {
                    Toast.makeText(TransportActivity.this, "Something went wrong", Toast.LENGTH_SHORT).show();
                    mProgressDialog.dismiss();
                }
            }
