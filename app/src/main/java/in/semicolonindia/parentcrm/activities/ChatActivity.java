...
import in.semicolonindia.parentcrm.adapters.ChatListAdapter;
import in.semicolonindia.parentcrm.beans.Chats;
import in.semicolonindia.parentcrm.dialogs.ProgressDialog;
import in.semicolonindia.parentcrm.util.PreferencesManager;

import static in.semicolonindia.parentcrm.rest.BaseUrl.sGetMsg;
import static in.semicolonindia.parentcrm.rest.BaseUrl.sSendMsg;
    ...
    private void send(final String msg) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, sSendMsg, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("sender_id", new PreferencesManager(getApplicationContext()).getStudentID());
