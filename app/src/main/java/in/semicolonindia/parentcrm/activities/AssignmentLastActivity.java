...
import in.semicolonindia.parentcrm.adapters.AssignmentFinalAdapter;
import in.semicolonindia.parentcrm.R;

import static in.semicolonindia.parentcrm.rest.BaseUrl.sGetAssignmentURL;
@SuppressWarnings("ALL")
public class AssignmentLastActivity extends AppCompatActivity {

    private String sClassID;
    private String sStudID;

    ListView listView;
    AssignmentFinalAdapter assignmentFinalAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_assign_final);
       ...
       tvToolbarTitle .setText(mBundle.getString("name"));
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AssignmentLastActivity.this, AssignmentFirstActivity.class);
        ...
        etSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable arg0) {
                ...
                assignmentFinalAdapter.filter(text);
            }
            ...
            if (sResult != null) {
                try {
                    ...
                    if (!jsonObject.getBoolean("error")) {
                        ...
                        assignmentFinalAdapter = new AssignmentFinalAdapter(AssignmentLastActivity.this, arraylist);
                        listView.setAdapter(assignmentFinalAdapter);


                    } else {
                        Toast.makeText(AssignmentLastActivity.this, "Something went wrong", Toast.LENGTH_SHORT).show();
                    }
