...
public class NoticeboardActivity extends AppCompatActivity {
    ...
    NoticeboardStudentAdapter mNoticeboardStudentAdapter;
        ...
        lvStudentName.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                if(new ConnectionDetector(getApplicationContext()).isConnectingToInternet()){
                    ...
                    Intent intent = new Intent(getApplicationContext(), NoticeboardNextActivity.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    startActivity(intent);
                }else {
                    final NoConnectionDialog mNoConnectionDialog = new NoConnectionDialog(NoticeboardActivity.this,
    ...
    {
        mProgressDialog = new ProgressDialog(NoticeboardActivity.this, "Loading Noticeboard...");
            ...
            public void onResponse(String response) {
                if (response != null) {
                    ...
                    try {
                        ...
                        mNoticeboardStudentAdapter = new NoticeboardStudentAdapter(getApplicationContext(),arraylist, lvStudentName);
                ...
                {
                    Toast.makeText(NoticeboardActivity.this, "Something went wrong", Toast.LENGTH_SHORT).show();
                    mProgressDialog.dismiss();
                }
            }
