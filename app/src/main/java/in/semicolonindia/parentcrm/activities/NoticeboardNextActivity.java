...
import in.semicolonindia.parentcrm.adapters.NoticeboardListAdapter;
import in.semicolonindia.parentcrm.beans.NoticeNames;

import static in.semicolonindia.parentcrm.rest.BaseUrl.sGetNoticeboardURL;
@SuppressWarnings("ALL")
public class NoticeboardNextActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_noticeboard_next);
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(NoticeboardNextActivity.this, NoticeboardActivity.class);
                    ...
                    try {
                        ...
                        if (!jsonObject.getBoolean("error")) {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++)
                            {
                               ...
                               */
                                NoticeNames noticeNames = new NoticeNames(noticeObject.getString("notice_title"),
                                        noticeObject.getString("date_added"),
                                        noticeObject.getString("notice"));

                                arraylist.add(noticeNames);
                            }

                            mNoticeboardListAdapter = new NoticeboardListAdapter(NoticeboardNextActivity.this,
                                    arraylist);
