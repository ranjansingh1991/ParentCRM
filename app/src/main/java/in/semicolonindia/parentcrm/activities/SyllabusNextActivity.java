...
import in.semicolonindia.parentcrm.adapters.SyllabusListAdapter;
import in.semicolonindia.parentcrm.beans.SyllabusNames;
import in.semicolonindia.parentcrm.dialogs.ProgressDialog;

import static in.semicolonindia.parentcrm.rest.BaseUrl.sGetSyllabusURL;

@SuppressWarnings("ALL")


public class SyllabusNextActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_syllabus_next);
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SyllabusNextActivity.this, SyllabusActivity.class);
    ...
    private void getSyllabus() {
        mProgressDialog = new ProgressDialog(SyllabusNextActivity.this, "Loading Syllabus...");
                ...
                if (sResult != null) {
                    ...
                    try {
                        ...
                        if (!jsonObject.getBoolean("error")) {
                            ...
                            sUploader = new String[jsonArray.length()];
                            sDate = new String[jsonArray.length()];
                            sFile = new String[jsonArray.length()];
                            sDesp = new String[jsonArray.length()];
                            for (int i = 0; i < jsonArray.length(); i++) {

                                JSONObject syllabusObject = jsonArray.getJSONObject(i);
                                SyllabusNames itemDetails = new SyllabusNames(syllabusObject.getString("title"),
                                        syllabusObject.getString("subject_name"),
                                        syllabusObject.getString("uploader_type"),
                                        syllabusObject.getString("year"),
                                        syllabusObject.getString("file_name"),
                                        syllabusObject.getString("description"));

                                arraylist.add(itemDetails);
                            }

                            mSyllabusListAdapter = new SyllabusListAdapter(SyllabusNextActivity.this, arraylist);
                            lvSyllabus.setAdapter(mSyllabusListAdapter);


                        } else {
                            Toast.makeText(SyllabusNextActivity.this, "Something went wrong", Toast.LENGTH_SHORT).show();
                        }
