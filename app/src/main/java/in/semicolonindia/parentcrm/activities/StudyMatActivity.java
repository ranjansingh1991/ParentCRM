...
import in.semicolonindia.parentcrm.adapters.StudentStudyMatAdapter;
...
public class StudyMatActivity extends AppCompatActivity {
    ...
    StudentStudyMatAdapter mStudentListAdapter;
        ...
        lvStudentName.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(new ConnectionDetector(getApplicationContext()).isConnectingToInternet()) {
                    ...
                    Intent intent = new Intent(getApplicationContext(), StudyMatNextActivity.class);
                    ...
                    final NoConnectionDialog mNoConnectionDialog = new NoConnectionDialog(StudyMatActivity.this,
    ...
    private void getChildrenList() {
        mProgressDialog = new ProgressDialog(StudyMatActivity.this, "Loading Study Material...");
            ...
            public void onResponse(String response) {
                if (response != null) {
                    ...
                    try {
                        ...
                        mStudentListAdapter = new StudentStudyMatAdapter(getApplicationContext(), arraylist, lvStudentName);
                    ...
                    Toast.makeText(StudyMatActivity.this, "Something went wrong", Toast.LENGTH_SHORT).show();
                    mProgressDialog.dismiss();
                }
