...
public class AssignmentFirstActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AssignmentFirstActivity.this, HomeActivity.class);
        ...
        lvStudentEML.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (new ConnectionDetector(getApplicationContext()).isConnectingToInternet()) {
                    ...
                    Intent intent = new Intent(getApplicationContext(), AssignmentLastActivity.class);
                ...
                // 2. Here we create ConnectionDetector class to check internet connection .
                    ...
                    final NoConnectionDialog mNoConnectionDialog = new NoConnectionDialog(AssignmentFirstActivity.this,
    ...
    public void getChildrenList() {
        mProgressDialog = new ProgressDialog(AssignmentFirstActivity.this, "Loading Assignment ...");
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, sLoginURL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                if (response != null) {
                    ...
                    try {
                        ...
                        for (int i = 0; i < childArray.length(); i++) {
                            ...
                            StudentNames itemDetails = new StudentNames(childObject.getString("name"),
                                    ...
                                    childObject.getString("class_id"), childObject.getString("student_id"), 1);
                    ...
                    Toast.makeText(AssignmentFirstActivity.this, "Something went wrong", Toast.LENGTH_SHORT).show();
                }
                mProgressDialog.dismiss();
            }
