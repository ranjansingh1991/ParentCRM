...
public class MessageActivity extends AppCompatActivity {
    ...
    public void getChildrenList() {
        mProgressDialog = new ProgressDialog(MessageActivity.this, "Loading Messages...");
            ...
            public void onResponse(String response) {
                if (response != null) {
                    ...
                    try {
                        ...
                        mStudentListAdapter = new StudentListAdapter(getApplicationContext(), arraylist, lvStudentMSG);
