...
import in.semicolonindia.parentcrm.adapters.StudentSubjectListAdapter;
...
public class SubjectActivity extends AppCompatActivity {
    ...
    StudentSubjectListAdapter mStudentListAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvStudentName = (ListView)findViewById(R.id.lvSubjects);
        // Methods Call............
        getChildrenList();
        ...
        lvStudentName.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(getApplicationContext(), SubjectNextActivity.class);
                ...
                overridePendingTransition(R.anim.slide_in_bottom, R.anim.slide_out_bottom);
                    ...
                    final NoConnectionDialog mNoConnectionDialog = new NoConnectionDialog(SubjectActivity.this,
    ...
    {
        mProgressDialog = new ProgressDialog(SubjectActivity.this, "Loading Subject...");
            ...
            public void onResponse(String response)
            {
                if (response != null)
                {
                    ...
                    try
                    {
                        ...
                        mStudentListAdapter= new StudentSubjectListAdapter(getApplicationContext(), arraylist, lvStudentName);
                ...
                {
                    Toast.makeText(SubjectActivity.this, "Something went wrong", Toast.LENGTH_SHORT).show();
                    mProgressDialog.dismiss();
                }
            }
