...
import in.semicolonindia.parentcrm.adapters.ExtracurriculamListAdapter;
import in.semicolonindia.parentcrm.beans.ExtraCurriculamNames;
@SuppressWarnings("ALL")
public class ExtraCurriculumActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_extra_curriculum_demo);
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ExtraCurriculumActivity.this, HomeActivity.class);
