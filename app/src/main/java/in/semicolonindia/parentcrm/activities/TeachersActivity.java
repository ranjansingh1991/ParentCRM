...
import in.semicolonindia.parentcrm.adapters.NoticeboardStudentAdapter;
import in.semicolonindia.parentcrm.adapters.StudentListAdapter;
...
public class TeachersActivity extends AppCompatActivity {
    ...
    StudentTeacherListAdapter mTeachersListAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable arg0) {
                ...
                mTeachersListAdapter.filter(text);
        ...
        lvStudentName.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (new ConnectionDetector(getApplicationContext()).isConnectingToInternet()) {
                    ...
                    Intent intent = new Intent(getApplicationContext(), TeacherNextActivity.class);
                    intent.putExtras(bundle);
                    startActivity(intent);
                    overridePendingTransition(R.anim.slide_in_bottom, R.anim.slide_out_bottom);
                    // 2. Here we create ConnectionDetector class to check internet connection .
                    // if connection is not available then dailog box will o
                }else {
                    final NoConnectionDialog mNoConnectionDialog = new NoConnectionDialog(getApplicationContext(),
    ...
    public void getChildrenList() {
        mProgressDialog = new ProgressDialog(TeachersActivity.this, "Loading Teacher...");
            ...
            public void onResponse(String response) {
                if (response != null) {
                    ...
                    try {
                        ...
                        mTeachersListAdapter = new StudentTeacherListAdapter(getApplicationContext(), arraylist, lvStudentName);
                        lvStudentName.setAdapter(mTeachersListAdapter);
                    } catch (Exception e) {
                        e.printStackTrace();
                        mProgressDialog.dismiss();
                    }
                } else {
                    Toast.makeText(TeachersActivity.this, "Something went wrong", Toast.LENGTH_SHORT).show();
                    mProgressDialog.dismiss();
                }
            }
