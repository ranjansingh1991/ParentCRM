package in.semicolonindia.parentcrm.widget.progress_bar;
...
public class AVLoadingIndicatorViewLight extends View {
    ...
    public void setIndicator(String indicatorName) {
        ...
        try {
            Class<?> drawableClass = Class.forName("in.semicolonindia.parentcrm.widget.progress_bar.SquareSpinIndicator");
