...
import static in.semicolonindia.parentcrm.rest.BaseUrl.sAssignmentDownloadURL;
import static in.semicolonindia.parentcrm.rest.BaseUrl.sSyllabusDocDownloadURL;

/**
 * Created by Rupesh on 14-12-2017.
 */
@SuppressWarnings("ALL")
public class DownloadTaskAcademicSyllabus extends AsyncTask<String, String, String> {
    ...
    public DownloadTaskAcademicSyllabus(Activity activity, String sFileName) {
