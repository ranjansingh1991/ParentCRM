...
import in.semicolonindia.parentcrm.util.DownloadTaskStudyMaterial;
...
public class StudyMatListAdapter extends BaseAdapter {
    ...
    public StudyMatListAdapter(Activity activity, List<StudyMatNames> studyMatNamesList, ListView lvStudyMat) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        holder.tvTitle.setText(studyMatNamesList.get(position).getsTitle());
        holder.tvSubject.setText(studyMatNamesList.get(position).getsSubject());
        holder.tvClass.setText(studyMatNamesList.get(position).getsClass());
        holder.tvDate.setText(studyMatNamesList.get(position).getsDate());
        holder.tvFile.setText(studyMatNamesList.get(position).getsFile());
        holder.tvDesp.setText(studyMatNamesList.get(position).getsDesp());
        ...
        holder.btnDownload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (new ConnectionDetector(activity).isConnectingToInternet()) {
                    ...
                    new DownloadTaskStudyMaterial(activity, studyMatNamesList.get(position).getsFile())
