...
import in.semicolonindia.parentcrm.LoginActivity;
import in.semicolonindia.parentcrm.R;
import in.semicolonindia.parentcrm.beans.AccountBean;
import in.semicolonindia.parentcrm.civ.CircleImageView;
import in.semicolonindia.parentcrm.dialogs.PasswordChangeDialog;
import in.semicolonindia.parentcrm.dialogs.ProgressDialog;
import in.semicolonindia.parentcrm.util.PreferencesManager;

import static in.semicolonindia.parentcrm.rest.BaseUrl.sUploadUserInfoURL;
...
public class AccountListAdapter extends RecyclerView.Adapter<AccountListAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case 0:
                rootView = LayoutInflater.from(parent.getContext()).inflate(R.layout.account_list_header, parent, false);
                mViewHolder = new ViewHolder(rootView, viewType);
                break;

            case 1:
                rootView = LayoutInflater.from(parent.getContext()).inflate(R.layout.account_list_body_items, parent, false);
                mViewHolder = new ViewHolder(rootView, viewType);
                break;

            case 2:
                rootView = LayoutInflater.from(parent.getContext()).inflate(R.layout.account_list_control_items, parent, false);
                mViewHolder = new ViewHolder(rootView, viewType);
                break;
        }
        return mViewHolder;
