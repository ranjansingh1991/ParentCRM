...
import in.semicolonindia.parentcrm.dialogs.DialogNoticeBoard;

import static in.semicolonindia.parentcrm.R.id.tvNoticeName;
...
public class NoticeboardListAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.tvNoticeName = (TextView) convertView.findViewById(tvNoticeName);
