...
public class AttendanceDataRVAdapter extends RecyclerView.Adapter<AttendanceDataRVAdapter.ViewHolder> {
    ...
    @Override
    public AttendanceDataRVAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.attandance_list_item_data, parent, false);
        AttendanceDataRVAdapter.ViewHolder mViewHolder = new AttendanceDataRVAdapter.ViewHolder(view);
        return mViewHolder;
    }

    @Override
    public void onBindViewHolder(AttendanceDataRVAdapter.ViewHolder holder, int position) {
