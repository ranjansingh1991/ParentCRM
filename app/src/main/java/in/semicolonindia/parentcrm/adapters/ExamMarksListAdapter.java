...
/**
 * Created by RANJAN SINGH on 9/28/2017.
 */
...
public class ExamMarksListAdapter extends RecyclerView.Adapter<ExamMarksListAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view;
        if (viewType == 0) {
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.exam_marks_header, parent, false);
            mViewHolder = new ExamMarksListAdapter.ViewHolder(view, viewType);
        } else {
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.exam_marks_list_item, parent, false);
            mViewHolder = new ExamMarksListAdapter.ViewHolder(view, viewType);
        }
