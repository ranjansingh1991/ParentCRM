package in.semicolonindia.parentcrm.services;
...
import static in.semicolonindia.parentcrm.rest.BaseUrl.sGetNewMsg;

/**
 * Created by Rupesh on 30-12-2017.
 */
                ...
                if (sResult != null) {
                    try {
                        ...
                        if (jsonArray.length() > 0) {
                            ...
                            Intent attractionintent = new Intent(MessageService.this,
                                    in.semicolonindia.parentcrm.activities.MessageActivity.class);
